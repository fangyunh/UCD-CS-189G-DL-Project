...
class Method_MLP(method, nn.Module):
    ...
    def forward(self, x):
        ...
        output_l1 = self.activation_func_1(self.fc_layer_1(x))
        output_l2 = self.activation_func_2(self.fc_layer_2(output_l1))
        #use for 4 layers
        #output_l3 = self.activation_func_3(self.fc_layer_3(output_l2))
        ...
        y_pred = self.activation_func_3(self.fc_layer_3(output_l2))
        #use for 4 layers
        #y_pred = self.activation_func_4(self.fc_layer_4(output_l3))
        return y_pred
    ...
    def train(self, X, y):
        ...
        for epoch in range(self.max_epoch): # you can do an early stop if self.max_epoch is too much...
            ...
            if epoch%100 == 0:
                ...
                print('Epoch:', epoch, 'Evaluation:', accuracy_evaluator.evaluate(), 'Loss:', train_loss.item())
